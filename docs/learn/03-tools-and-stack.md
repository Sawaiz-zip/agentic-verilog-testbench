...
**How often was it needed?** Rarely — 4 parse failures out of 314 analyses. In the one case
we examined, the testbench did not compile either, so nothing was lost.
